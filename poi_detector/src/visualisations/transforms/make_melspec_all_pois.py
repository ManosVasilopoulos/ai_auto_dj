...
def main():
    ...
    ax_img = librosa.display.specshow(x, cmap='viridis', x_axis='time', y_axis='mel', sr=sr, fmax=sr//2)
    plt.colorbar(format='%+2.0f dB')
    plt.title('The Box by Roddy Ricch - Mel-spectrogram with all Points of Interest')
    plt.show()
