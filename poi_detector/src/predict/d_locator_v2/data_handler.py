...
class Locator2DataHandler:
    ...
    def __init__(self, playlist_dir: str,
        ...
        self.playlist = os_listdir(playlist_dir)
    ...
    def extract_song_name(self, song_transform_name: str):
        for filename in self.playlist:
            if filename in song_transform_name:
                return filename
        raise Exception(
            'Locator2DataHandlerError: did not find a matching name for: ' + song_transform_name + ' in ' + self.playlist_dir)
